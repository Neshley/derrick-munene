...
export const WORSHIP_GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    category: "Getting Started",
    level: 3,
    summary: "Complete introduction to DM ARRANGIA 2.8.0, core architectural stack, and realistic Yamaha file compatibility scope.",
    content: [
      "Welcome to DM ARRANGIA (Version 2.8.0 Professional Edition), conceived and architected by Derrick Munene (Lead Architect & Worship Keyboardist). DM ARRANGIA is an advanced, browser-native arranger workstation and live performance companion engineered specifically for solo musicians, church worship keyboardists, vocalists, and music producers.",
    ...
    table: {
      ...
      rows: [
        ...
        ["Version & Build", "v2.8.0 Professional Edition (September 2026)"],
...
**Version 2.8.0 Professional Edition — Last Updated: September 2026**
